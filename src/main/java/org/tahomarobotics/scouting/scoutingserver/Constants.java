...
public class Constants {
    ...
    public static final String DATABASE_FILEPATH = "src/main/resources/org/tahomarobotics/scouting/scoutingserver/database/jankDatabase.txt";
    public static final String EXCEL_DATABASE = "src/main/resources/org/tahomarobotics/scouting/scoutingserver/database/testDatabase.xlsx";

...
public class Constants {
   ...
   // public static final String IMAGE_DATA_FILEPATH = "src/main/resources/org/tahomarobotics/scouting/scoutingserver/images/";
    //public static final String BASE_FILEPATH = System.getenv("APPDATA") + "/BearMetalScoutingServer";//this is for produciton
    public static final String BASE_FILEPATH = System.getProperty("user.dir");//this is for development
    public static final String IMAGE_DATA_FILEPATH = BASE_FILEPATH + "/resources/images/";
    public static final String DATABASE_FILEPATH = BASE_FILEPATH + "/resources/database/";
